...
/**
 * Families withheld from public surfaces (nav, catalogue, sitemap, featured).
 * Keep the family in `FAMILY_ORDER` and CMS/admin — just remove from this set
 * to bring the category back.
 */
export const HIDDEN_FAMILIES: ReadonlySet<ProductFamilyId> = new Set([
  "Cable Accessories",
]);

export function isFamilyListed(family: ProductFamilyId | string): boolean {
  return !HIDDEN_FAMILIES.has(family as ProductFamilyId);
}

/** Public family list — use this instead of `FAMILY_ORDER` on the site. */
export function listFamilies(): ProductFamilyId[] {
  return FAMILY_ORDER.filter(isFamilyListed);
}
...
export const PRODUCT_DRAWINGS: Readonly<Record<string, string>> = {
  ...
  "line-post-24-36":
    "/images/product-drawings/drawing-line-post-24-36-v2.png",
  "suspension-tension-63-110":
    "/images/product-drawings/drawing-suspension-tension-63-110-v2.png",
  "suspension-tension-132-161":
    "/images/product-drawings/drawing-suspension-tension-132-161-v2.png",
  "suspension-tension-220-230":
    "/images/product-drawings/drawing-suspension-tension-220-230-v2.png",
  "suspension-tension-330":
    "/images/product-drawings/drawing-suspension-tension-330-v2.png",
...
export const PRODUCTS: readonly Product[] = [
  // ── 01 · Silicone Composite Insulators ──
  {
    ...
    image: "/images/product-suspension-tension-24-36.jpg",
    order: 10,
    variants: [
      {
        code: "DPL11-440-70TC",
  ...
  },
  {
    ...
    image: "/images/product-line-post-24-36.jpg",
    drawing: "/images/product-drawings/drawing-line-post-24-36-v2.png",
    order: 11,
    variants: [
      {
        code: "DPL11-420-6L",
        ...
        technical: {
          ...
          sectionLength: "370±15",
          arcingDistance: "240",
          shedDiameter: "140/125",
          minimumCreepage: "420",
          impulseWithstand: "135",
          impulseNegative: "150",
          dryWithstand: "65",
          wetWithstand: "50",
        },
      ...
      },
      {
        ...
        technical: {
          ...
          sectionLength: "480±15",
          arcingDistance: "260",
          shedDiameter: "145/125",
          minimumCreepage: "620",
          impulseWithstand: "190",
          impulseNegative: "205",
          dryWithstand: "85",
          wetWithstand: "70",
        },
      ...
      },
      {
        code: "DPL36-700-6L",
        voltage: "36 kV",
        sectionLength: "325±15 mm",
        creepage: "700 mm",
        technical: {
          ratedVoltage: "36",
          sml: "6",
          sectionLength: "325±15",
          arcingDistance: "330",
          shedDiameter: "142/120",
          minimumCreepage: "700",
          impulseWithstand: "210",
          impulseNegative: "240",
          dryWithstand: "95",
          wetWithstand: "80",
        },
  ...
  {
    id: "silicone-post-24-400",
    name: "24–400 kV Silicone Post Insulator",
    family: "Silicone Composite Insulators",
    subFamily: "Composite Post",
    catalogueRef: "DPL175 · DPL204 · DPL325 · DPL650 · DPL1050 · DPL1550 — PI series",
    summary:
      "Silicone composite post insulators for distribution through transmission, 24–400 kV. Pin-type and station-class mechanical ratings with IEC type-tested creepage and impulse performance.",
    applications: "Line post · Station post · Distribution & transmission",
    ...
    variants: [
      {
        ...
        voltage: "24 kV",
        sectionLength: "300±15 mm",
        creepage: "700 mm",
        technical: {
          ratedVoltage: "24",
          sml: "10",
          sectionLength: "300±15",
          arcingDistance: "250",
          shedDiameter: "132/115",
          minimumCreepage: "700",
          impulseWithstand: "175",
          wetWithstand: "70",
        },
      },
      {
        code: "DPL175-920-10PI",
        voltage: "24 kV",
        sectionLength: "360±15 mm",
        creepage: "920 mm",
        technical: {
          ratedVoltage: "24",
          sml: "10",
          sectionLength: "360±15",
          arcingDistance: "310",
          shedDiameter: "132/115",
          minimumCreepage: "920",
          impulseWithstand: "175",
      ...
      {
        code: "DPL204-1175-10PI",
        voltage: "36 kV",
        sectionLength: "420±15 mm",
        creepage: "1175 mm",
        technical: {
          ratedVoltage: "36",
          sml: "10",
          sectionLength: "420±15",
          arcingDistance: "370",
          shedDiameter: "100/80",
          minimumCreepage: "1175",
          impulseWithstand: "204",
          wetWithstand: "75",
        },
      },
      {
        code: "DPL204-1440-10PI",
        voltage: "36 kV",
        sectionLength: "480±15 mm",
        creepage: "1440 mm",
        technical: {
      ...
      {
        code: "DPL325-2560-8PI",
        voltage: "63 kV",
        sectionLength: "770±15 mm",
        creepage: "2560 mm",
        technical: {
          ratedVoltage: "63",
          sml: "8",
          sectionLength: "770±15",
          arcingDistance: "690",
          shedDiameter: "175/145",
          minimumCreepage: "2560",
          impulseWithstand: "325",
          wetWithstand: "180",
        },
      },
      {
        code: "DPL325-2560-10PI",
        voltage: "63 kV",
        sectionLength: "770±15 mm",
        creepage: "2560 mm",
        technical: {
      ...
      },
      {
        ...
        technical: {
          ...
          arcingDistance: "680",
          shedDiameter: "175/145",
          minimumCreepage: "2370",
          impulseWithstand: "325",
          wetWithstand: "180",
        },
      },
      {
        code: "DPL650-6200-8PI",
        voltage: "132 kV",
        sectionLength: "1500±15 mm",
        creepage: "6200 mm",
        technical: {
          ratedVoltage: "132",
          sml: "8",
          sectionLength: "1500±15",
          arcingDistance: "1410",
          shedDiameter: "230/195",
          minimumCreepage: "6200",
          impulseWithstand: "650",
          wetWithstand: "275",
        },
      },
      {
        code: "DPL650-6200-10PI",
        voltage: "132 kV",
        sectionLength: "1500±15 mm",
        creepage: "6200 mm",
        technical: {
      ...
      {
        code: "DPL1050-9860-10PI",
        voltage: "230 kV",
        sectionLength: "2300±15 mm",
        creepage: "9860 mm",
        technical: {
          ratedVoltage: "230",
          sml: "10",
          sectionLength: "2300±15",
          arcingDistance: "2180",
          shedDiameter: "230/195",
          minimumCreepage: "9860",
          impulseWithstand: "1050",
          wetWithstand: "460",
        },
      },
      {
        code: "DPL1050-9860-12.5PI",
        voltage: "230 kV",
        sectionLength: "2300±15 mm",
        creepage: "9860 mm",
        technical: {
      ...
      },
      {
        ...
        technical: {
          ...
          arcingDistance: "3121",
          shedDiameter: "270/230",
          minimumCreepage: "14121",
          impulseWithstand: "1550",
          wetWithstand: "680",
        },
      },
      {
        code: "DPL1550-14121-12.5PI",
        voltage: "400 kV",
        sectionLength: "3350±15 mm",
        creepage: "14121 mm",
        technical: {
      ...
      },
      {
        ...
        technical: {
          ...
          arcingDistance: "3735",
          shedDiameter: "270/230",
          minimumCreepage: "16865",
          impulseWithstand: "1550",
          wetWithstand: "680",
        },
      },
      {
        code: "DPL1550-16865-12.5PI",
        voltage: "400 kV",
        sectionLength: "3930±15 mm",
        creepage: "16865 mm",
        technical: {
  ...
  },
  {
    ...
    standard: "IEC 61109 · IEC 61192",
    image: "/images/product-suspension-tension-63-110.jpg",
    drawing: "/images/product-drawings/drawing-suspension-tension-63-110-v2.png",
    order: 12,
    variants: [
      {
  ...
  },
  {
    ...
    standard: "IEC 61109 · IEC 61192",
    image: null,
    drawing: "/images/product-drawings/drawing-suspension-tension-132-161-v2.png",
    order: 13,
    variants: [
      {
  ...
  },
  {
    ...
    standard: "IEC 61109 · IEC 61192",
    image: null,
    drawing: "/images/product-drawings/drawing-suspension-tension-220-230-v2.png",
    order: 14,
    variants: [
      {
  ...
  },
  {
    ...
    standard: "IEC 61109 · IEC 61192",
    image: null,
    drawing: "/images/product-drawings/drawing-suspension-tension-330-v2.png",
    order: 15,
    variants: [
      {
  ...
  },
  {
    ...
    standard: "IEC 61109 · IEC 61192",
    image: null,
    drawing: "/images/product-drawings/drawing-suspension-tension-400-v2.png",
    order: 16,
    variants: [
      {
  ...
  },
  {
    ...
    family: "Silicone Composite Insulators",
    subFamily: "Suspension / Tension",
    catalogueRef: "DPL500 — 160/210 · 300 BS series",
    summary:
    ...
    standard: "IEC 61109 · IEC 61192",
    image: null,
    drawing: "/images/product-drawings/drawing-suspension-tension-500-v2.png",
    order: 17,
    hidden: false,
    variants: [
      {
        code: "DPL500-17700-160/210",
        voltage: "500 kV",
        ...
        technical: {
          ...
          shedDiameter: "160/125",
          shedNo: "60",
          minimumCreepage: "17700",
          impulseWithstand: "2250",
          dryWithstand: "740",
          switchingWithstand: "1240",
          wetWithstand: "740",
        },
      },
      {
        code: "DPL500-17700-300BS",
        voltage: "500 kV",
  ...
  {
    id: "hybrid-post-63-400",
    name: "63–400 kV Hybrid (Silicone Ceramic) Post Insulator",
    family: "Hybrid Insulators",
    subFamily: "Silicone – Ceramic",
    catalogueRef: "DPL325 · DPL650 · DPL1050 · DPL1550 — HPI series",
    summary:
      "Hybrid silicone–ceramic post insulators for 63–400 kV. Porcelain core with HTV silicone housing for station and line-post duty in polluted, coastal and industrial environments.",
    applications: "Substation post · Line post · Industrial · Coastal",
    ...
    variants: [
      {
        ...
        technical: {
          ...
          arcingDistance: "740",
          shedDiameter: "175/145",
          minimumCreepage: "3100",
          impulseWithstand: "325",
          wetWithstand: "180",
        },
      },
      {
        code: "DPL650-6150-8HPI",
        voltage: "132 kV",
        sectionLength: "1500±15 mm",
        creepage: "6150 mm",
        technical: {
          ...
          sectionLength: "1500±15",
          arcingDistance: "1336",
          shedDiameter: "305/270",
          minimumCreepage: "6150",
          impulseWithstand: "650",
          wetWithstand: "275",
        },
      },
      {
        code: "DPL650-6150-10HPI",
        voltage: "132 kV",
        sectionLength: "1500±15 mm",
        creepage: "6150 mm",
        technical: {
      ...
      },
      {
        ...
        technical: {
          ...
          arcingDistance: "2043",
          shedDiameter: "305/270",
          minimumCreepage: "9830",
          impulseWithstand: "1050",
          wetWithstand: "460",
        },
      },
      {
        code: "DPL1050-9830-12.5HPI",
        voltage: "230 kV",
        sectionLength: "2300±15 mm",
        creepage: "9830 mm",
        technical: {
...
export function isProductListed(product: Product): boolean {
  if (!isFamilyListed(product.family)) return false;
...
export function getProductsByFamily(): Record<ProductFamilyId, Product[]> {
  ...
  for (const f of listFamilies()) grouped[f] = [];
  for (const p of listProducts(PRODUCTS)) {
    if (!grouped[p.family]) continue;

...
export const CATALOGUE_UI = {
  en: {
    ...
    viewsHintBefore: "Every product card opens ",
    viewDatasheet: "Table & drawing",
    viewsHintAfter:
      " — sectional diagram on top, full ratings table below. Opens in place.",
    viewTable: "Table",
    viewsHintMid: "",
    viewDrawing: "Drawing",
  ...
  fa: {
    ...
    viewsHintBefore: "هر کارت باز می‌کند ",
    viewDatasheet: "جدول و نقشه",
    viewsHintAfter:
      " — نقشه بالا، جدول مقادیر پایین. در همان صفحه باز می‌شود.",
    viewTable: "جدول",
    viewsHintMid: "",
    viewDrawing: "نقشه",

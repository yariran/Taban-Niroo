          ...
          >
            {MAGICAL_FEATURES.map((feature) => (
              ...
              >
                ...
                <h3 className="mt-4 text-xl font-medium tracking-tight text-brand-navy md:text-2xl">
                  {feature.title}
                </h3>
            ...
            >
              {RAW_MATERIALS.map((item) => (
                ...
                >
                  ...
                  <p className="mt-4 text-lg font-medium text-brand-navy md:text-xl">
                    {item.title}
                  </p>
          ...
          <div id="patents" className="mt-24 md:mt-32">
            <div className="flex flex-col gap-3 border-b border-border pb-6 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-medium tracking-tight text-brand-navy md:text-3xl">
            ...
            <RevealBlock className="grid grid-cols-1 divide-y divide-border md:grid-cols-3 md:divide-x md:divide-y-0">
              {PATENTS_BRIEF.map((patent) => (
                ...
                >
                  ...
                  <p className="mt-2 text-xs uppercase tracking-widest text-brand-burgundy">
                    {patent.subtitle}
                  </p>
                </div>
              ))}
